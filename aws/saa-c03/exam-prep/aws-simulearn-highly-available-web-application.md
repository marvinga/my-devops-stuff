...
| **Determine the benefits of using an Application Load Balancer.** | Help the travel agency create a highly available web application architecture. | 2. Create an **Application Load Balancer (ELB)** so that network traffic is distributed equally across your EC2 instances. | **Elastic Load Balancing** |  |
